...
public class SubsystemViewManagement {
	...
	private SubsystemViewManagement() {
	...
	public static synchronized SubsystemViewManagement getInstance() {
		if (SubsystemViewManagement.instance == null) {
			SubsystemViewManagement.instance = new SubsystemViewManagement();
		}
		return SubsystemViewManagement.instance;
	}
	...
	public void showSubsystems(ArrayList<SubsystemGraph> subsystems, boolean clearView, boolean useColor) {
		...
		GsmmExplorerController.getInstance().getTab().setSubsystemInfo(currentSubSystems.size(), species, reactions);
	}
	...
	public void replaceSubsystems(ArrayList<SubsystemGraph> subsystems, boolean useColor) {
		for (SubsystemGraph subsystem : currentSubSystems) {
			AttributeHelper.setFillColor(GsmmExplorerController.getInstance().getCurrentSession().getOverviewGraph()
