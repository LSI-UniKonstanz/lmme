...
/**
 * TODO: re-write!
 * This is the main class of the GSMM exploration Add-On. This Add-On
 ...
 */
public class GsmmExplorerAddon extends AddonAdapter {
	
	@Override
	protected void initializeAddon() {
		
		this.tabs = new InspectorTab[] { new GsmmExplorerTab() };
