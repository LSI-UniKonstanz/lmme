...
public class LayoutTools {
	...
	private static LayoutTools instance;

	private LayoutTools() {
	}

	public static synchronized LayoutTools getInstance() {
		if (LayoutTools.instance == null) {
			LayoutTools.instance = new LayoutTools();
		}
		return LayoutTools.instance;
	}
